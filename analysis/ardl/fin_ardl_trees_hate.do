...
foreach file in `files' {
  ...
  norm speech_hate_yes strategy_opin strategy_sarc strategy_construct goal2_out_negative goal2_in_both_pos anger fear ///
  disgust sadness enthop prijoy , method(zee)
		
  capture noisily ardl zee_speech_hate_yes zee_strategy_opin zee_strategy_sarc zee_strategy_construct ///
  ...
  estadd matrix x=e(b)  
  capture esttab using "C:\Users\mirta\Dropbox\SFI Reconquista\00 strategies\analyses\trees100d\hate_joint_rob3\regs_hate_`file'.csv", se nostar 
}
