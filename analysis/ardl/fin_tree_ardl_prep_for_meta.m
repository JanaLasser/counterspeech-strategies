...
pathreg="C:\Users\mirta\Dropbox\SFI Reconquista\00 strategies\analyses\trees100\tox_joint_rob3\";
...
for j=1:3660
    try
    j
    temp=readtable(pathreg + "regs_tox_d_basic_100_" + num2str(j) +".xlsx.csv",'Format','%s %s','ReadRowNames',false);
    temp(end,:)=[];
...
pathreg="C:\Users\mirta\Dropbox\SFI Reconquista\00 strategies\analyses\trees100\extsp_joint_rob3\";
...
for j=1:3660
    try
    j
    temp=readtable(pathreg + "regs_extsp_d_basic_100_" + num2str(j) +".xlsx.csv",'Format','%s %s','ReadRowNames',false);
    temp(end,:)=[];
    for i=2:2:height(temp)-2
        if length(temp{i,1}{1})>3
...
pathreg="C:\Users\mirta\Dropbox\SFI Reconquista\00 strategies\analyses\trees100\hate_joint_rob3\";
...
for j=1:3660
    try
    j
    temp=readtable(pathreg + "regs_hate_d_basic_100_" + num2str(j) +".xlsx.csv",'Format','%s %s','ReadRowNames',false);
    temp(end,:)=[];
    for i=2:2:height(temp)-2
        if length(temp{i,1}{1})>3
...
pathreg="C:\Users\mirta\Dropbox\SFI Reconquista\00 strategies\analyses\trees100\extind_joint_rob3\";
...
for j=1:3660
    try
    j
    temp=readtable(pathreg + "regs_extind_d_basic_100_" + num2str(j) +".xlsx.csv",'Format','%s %s','ReadRowNames',false);
    temp(end,:)=[];
    for i=2:2:height(temp)-2
        if length(temp{i,1}{1})>3
