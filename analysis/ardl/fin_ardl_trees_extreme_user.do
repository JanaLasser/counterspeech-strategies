...
foreach file in `files' {
  ...
  norm user_group_70e strategy_opin strategy_sarc strategy_construct goal2_out_negative goal2_in_both_pos anger fear ///
  disgust sadness enthop prijoy, method(zee)
		
  capture noisily ardl zee_user_group_70e zee_strategy_opin zee_strategy_sarc zee_strategy_construct ///
  ...
  capture noisily estadd matrix x=e(b)  
  capture esttab using "C:\Users\mirta\Dropbox\SFI Reconquista\00 strategies\analyses\trees100d\extind_joint_rob3\regs_extind_`file'.csv", se nostar 
}
