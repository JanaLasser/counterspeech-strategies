...
- `labeling`:
  - `interrater reliability.ipynb`: code to compute interrater reliability of human annotations for each of the annotation rounds (batches)
...
- `analysis`: statistical analysis for three levels of aggregation - reply pairs, conversations, and day level
  ...
  - `descriptive statistics.ipynb`: descriptive analysis (in Python)
