...
hate = np.argmax(norm_pred, axis=1)

df[f'hate'] = hate
for label in hate_dict.keys():
    df[hate_dict[label]] = norm_pred[0:, label]

condensation_dict = {3:"", 2:"_condensed"}
fname = "inferred_hate{}_{}.csv"\
